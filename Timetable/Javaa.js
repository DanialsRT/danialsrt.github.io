...
var Reloaded = function () {
  ...
  if (location.href == "https://danialsrt.github.io/Timetable/Index.html") {
    ...
    if (result % 2 == 0) {
      if (
        location.href == "https://danialsrt.github.io/Timetable/Index2a.html"
      ) {
      } else {
        location.replace("https://danialsrt.github.io/Timetable/Index2a.html");
      }
    } else {
      if (
        location.href == "https://danialsrt.github.io/Timetable/Index1a.html"
      ) {
      } else {
        location.replace("https://danialsrt.github.io/Timetable/Index1a.html");
      }
    }
  }
